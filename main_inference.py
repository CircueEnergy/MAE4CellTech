...
import model_mae
from preprocess.datasets.finetune_dataset import BaseBatteryData
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='battery_mae', type=str, metavar='MODEL',
    ...
    parser.add_argument('--test_label', default='/home/guodongxu/tsinghua/code/dataset_split/test_label2.csv', type=str,
                        help='测试集标签路径')
...
def main(args):
    ...
    battery_data_args = {"data_path": ['/data/nfsdata/database/exp/tsinghua_20230428/result/exp_2/data',
                                       '/data/nfsdata/database/exp/tsinghua_20230428/result/exp_3/data',
                                       '/data/nfsdata/database/exp/tsinghua_20230428/result/exp_4/data'
                                       ],  # args.data_path,
                         "norm_path": '',  # args.norm_path,
                         "patch_len": 2,  # args.patch_len,
                         "car_type": 'tsinghua',  # args.car_type,
                         "ram": True,  # args.ram,
                         "single_data_len": 2 * 49,  # args.patch_len * args.tokens_len,
                         "interpolate": 30,  # args.interpolate,
                         "jobs": 10,  # args.num_workers,
                         "partition_train": False,  # args.partition_train,
                         "partition_nums": 4,  # args.partition_nums
                         "label_path":'./dataset_split/test_charge_label.csv',
                         }
    dataset_test = BaseBatteryData(battery_data_args)
    dataset_test.get_all_data()
    ...
    model = model_mae.__dict__[args.model](
    ...
    # train_stats, train_mongo_res, train_df, df_res_train 
    test_stats,mongo_res ,df,df_res_test = evaluate(data_loader_test, model, device)
